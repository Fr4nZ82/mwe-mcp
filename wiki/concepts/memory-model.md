...
([marker grammar §0](../design-notes/marker-grammar.md)). The
...
- **Editable by hand, per family.** A smart wiki is filesystem-authored:
  ...
  text or ACL ([reindex pipeline](../design-notes/reindex-pipeline.md)).
- **Backup is one snapshot.** `mwe-mcp backup` captures the workdir —
  `engine.db` first, the file tree second
  ([backup & DR](../design-notes/backup-and-dr.md)). The prose alone is
...
and [`../design-notes/redaction-policy.md`](../design-notes/redaction-policy.md);
...
[ingest-pipeline.md](../design-notes/ingest-pipeline.md)); a pasted
...
[rem-cycle.md](../design-notes/rem-cycle.md#auto-promote-sub-job).)
...
[roadmap §4](../roadmap.md)), `wiki-group`, `wiki-companion`
...
[`../design-notes/ingest-pipeline.md`](../design-notes/ingest-pipeline.md) (the
self side of agent-authored memory) and [roadmap §27](../roadmap.md).
...
> [captures buffer](../design-notes/narrative-buffer.md), promoted into
...
[`../design-notes/wiki-filesystem-ssot.md`](../design-notes/wiki-filesystem-ssot.md);
the reconciliation that keeps the index aligned after external edits is
in [`../design-notes/reindex-pipeline.md`](../design-notes/reindex-pipeline.md).
...
sub-wiki;
see [`../design-notes/narrative-buffer.md`](../design-notes/narrative-buffer.md)),
...
- **`region_start` / `region_end` are nullable** (`Option<i64>` in
  ...
  ([reindex pipeline](../design-notes/reindex-pipeline.md)).
...
> [`../design-notes/narrative-buffer.md`](../design-notes/narrative-buffer.md).
...
([the link grammar](../design-notes/recall-pipeline.md#link-grammar)),
...
[`../design-notes/narrative-compiler.md`](../design-notes/narrative-compiler.md).
...
([redaction policy](../design-notes/redaction-policy.md)), so the marker
...
[roadmap](../roadmap.md)). Treat the embed marker
...
| The exact `{{…}}…{{/}}` grammar and parser behaviour | [`../design-notes/marker-grammar.md`](../design-notes/marker-grammar.md) |
| How redaction renders a per-sender view of a page | [`../design-notes/redaction-policy.md`](../design-notes/redaction-policy.md) |
| The on-disk layout, `_meta.md`, atomic writes | [`../design-notes/wiki-filesystem-ssot.md`](../design-notes/wiki-filesystem-ssot.md) |
| Capture, supersede, forget, and dedup | [`../design-notes/capture-and-dedup.md`](../design-notes/capture-and-dedup.md) |
| How standard wikis buffer captures before compilation | [`../design-notes/narrative-buffer.md`](../design-notes/narrative-buffer.md) |
| How facts are compiled back into published prose (Il Cronista) | [`../design-notes/narrative-compiler.md`](../design-notes/narrative-compiler.md) |
| The smart-wiki family + the `companion: bool` marker | [`../design-notes/smart-wikis.md`](../design-notes/smart-wikis.md) |
| The nightly self-reorganisation | [`../design-notes/rem-cycle.md`](../design-notes/rem-cycle.md) |
