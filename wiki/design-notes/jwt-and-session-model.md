...
| `/mcp/token-refresh` endpoint | contract documented above in [§Token refresh](#token-refresh--staying-alive-without-admin-intervention); no handler yet | not implemented (planned — see the [roadmap](../roadmap.md)) |
