...
> [`mcp` dispatcher](../design-notes/mcp-dispatcher.md). Most are at
...
> [`smart-wikis.md`](../design-notes/smart-wikis.md) for the
...
> [`mcp-dispatcher.md`](../design-notes/mcp-dispatcher.md); the formal
...
[`mcp-dispatcher.md`](../design-notes/mcp-dispatcher.md).
