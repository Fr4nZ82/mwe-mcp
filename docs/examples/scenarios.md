...
| Wiki path | What | Note |
|---|---|---|
| `alice/acmecorp/_meta.md` + the carried page | New promoted sub-wiki | `wiki_type: wiki-tech` (a neutral placeholder string — an emerged sub-wiki has no behavioural type), `promoted_from: alice/lavoro.md`; the page comes over under its own name and nothing else is seeded |
