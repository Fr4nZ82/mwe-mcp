...
- **`subject_id` — who answers for it?** Unchanged, and decided exactly as the `subject_id` section says: the group whose `scope` the fact falls inside, else `user:<sender>`.
