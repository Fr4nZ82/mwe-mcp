...
**They are not alternatives — a fact carries both.** «Bilbo's creatinine has risen to 2.86» is ABOUT Bilbo (`subject_external: "Bilbo Baggins"`) and ANSWERED FOR by the household (`subject_id: "group:famiglia"`, because a family member's health falls inside that group's scope). Read the two questions separately and answer both:
