...
- **DO NOT ADD SPECIFICITY THE TURN DID NOT CARRY.** You may re-word freely; you may not make a claim sharper than the message made it. The test is not *was the detail written* but **is there an ANCHOR in the turn it follows from**. "Tomorrow", "Saturday", "the 5th" are anchors — resolving them against `current_time` adds no specificity and is exactly your job (see `body`, above). What you know from your own training is NOT an anchor.
  ...
  - **A BARE DAY OF THE MONTH TAKES THE NEAREST ONE, AND THE TENSE SAYS WHICH WAY.** "The 14th" names one day and the turn's clock names the rest, so there is exactly one right answer and it is never a choice among months. Look at `current_time`, then at the tense: a future or undated statement takes the NEXT 14th — the current month when that day is still to come, the month after when it has gone; a past-tense statement ("I paid on the 14th") takes the LAST one. Said on 3 April, "the 14th" is 14 April, not 14 May and not 14 March. Reaching for any other month is inventing an anchor exactly as an age is, and it is worse than leaving the ordinal bare, because a wrong date reads afterwards like one somebody stated. **A birthday is an anniversary and takes no year**, by the day-and-month rule above: "Nora's birthday is on 14 April", never "14 April 2026".
