...
version: 3.11
default_version_at_bootstrap: v3.11
...
- Output: `intent`: `"capture"`, `extractions`: TWO elements →
  - [0] `subject_id`: `"group:family"`, `allow_ids`: `[]`, `group_audience`: `[{"group": "family", "answer": "yes", "why": "the family's own shopping list"}]`, `fact_type`: `"plan"`, `target_page`: `"spesa.md"`, `style`: `"lista"`, `requested_container`: `true`, `topics`: `["shopping", "detergent"]`, `body`: `"detergent 2 bottles"`
...
- Output: `intent`: `"capture"`, `extractions`: one element →
  - `subject_id`: `"user:frodo"`, `allow_ids`: `[]`, `group_audience`: `[{"group": "family", "answer": "yes", "why": "an outing the family is part of"}]`, `fact_type`: `"plan"`, `style`: `"prosa-tecnica"`, `topics`: `["outings", "picnic"]`, `body`: `"Picnic organised for Saturday at 15:00."`
